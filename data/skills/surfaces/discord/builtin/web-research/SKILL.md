---
name: web-research
description: Use web tools for current/external information on Discord: searches, URL fetching, docs, GitHub/repo research, unfurl-suppressed citations, implementation examples, or fresh facts.
---
...
- Prefer concise inline links on the relevant claim or source label.
- Suppress citation unfurls by wrapping source URLs in angle brackets. For
  masked Markdown links, use `[label](<url>)`; for plain source links, use
  `<url>`.
